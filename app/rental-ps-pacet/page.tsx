...
export const metadata = {
  title: 'Rental PS Pacet — PS4 75k/malam, 8 Unit Live | Rental Sedulur',
  description: 'Rental PS Pacet — cek live 8 unit, PS4 130k/hari 75k/malam, PS3 100k/50k/350k. Paket malam hemat 40%. WA 081289538855',
}
    ...
    <main className="bg-[#F8FAFC] min-h-screen">
      ...
      <section className="bg-[#0F0F23] text-[#E2E8F0] py-12 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <h1 className="font-display text-3xl mt-3">RENTAL PS PACET — <span className="text-[#A78BFA]">LIVE AVAILABILITY</span></h1>
          <p className="mt-3 text-[#94A3B8]">Wilayah: Pacet — <span className="text-[#10B981]">● Tersedia</span> / <span className="text-[#F59E0B]">● Dibooking</span> update live dari Supabase. Paket malam 19:00-07:00 cuma 75k.</p>
        </div>
      </section>
      <section className="max-w-6xl mx-auto px-6 py-8">
        <h2 className="font-heading font-bold text-xl flex items-center gap-2">Daftar Harga Pacet <span className="text-xs px-2 py-1 rounded-full bg-white border" style={{borderColor: '#C0C0C0'}}>{units.length} unit • live</span></h2>
        ...
        <div className="mt-8 bg-white rounded-[16px] p-6" style={{border: '2px solid #C0C0C0', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.9)'}}>
          <h3 className="font-bold">FAQ Rental PS Pacet — Live</h3>
          ...
          <a href="https://wa.me/6281289538855?text=Halo%20kak%20mau%20rental%20PS%20Pacet%20-%20utm_source=rental-ps-pacet&utm_medium=wa" target="_blank" className="mt-4 inline-block text-white px-6 py-3 rounded-[12px] font-semibold cursor-pointer" style={{background: 'linear-gradient(180deg, #25D366 0%, #1DA851 100%)', border: '2px solid #C0C0C0', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.4)'}}>Chat WA 0812-8953-8855 — Pacet</a>
        </div>
      </section>
    </main>
  )
