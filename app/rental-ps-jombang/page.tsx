...
export const metadata = {
  title: 'Rental PS Jombang — PS4 75k/malam, 8 Unit Siap Antar | Rental Sedulur',
  description: 'Rental PS Jombang termurah — 5 PS4 130k/hari 75k/malam 500k/minggu, 3 PS3 100k/50k/350k. Paket malam hemat 40%, antar gratis, booking anti bentrok. WA 081289538855',
}
    ...
    <main className="bg-[#F8FAFC] min-h-screen">
      <section className="bg-[#0F0F23] text-[#E2E8F0] py-12">
        <div className="max-w-6xl mx-auto px-6">
          <h1 className="font-display text-3xl">RENTAL PS JOMBANG — <span className="text-[#A78BFA]">8 UNIT SIAP ANTAR</span></h1>
          <p className="mt-3 text-[#94A3B8]">Wilayah: Jombang dan sekitar — antar 1 jam, gratis 5km. Paket malam 19:00-07:00 cuma 75k (PS4).</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8">
        <h2 className="font-heading font-bold text-xl">Daftar Harga Jombang</h2>
        ...
        <div className="mt-8 bg-white border border-[#E2E8F0] rounded-[12px] p-6">
          <h3 className="font-bold">FAQ Rental PS Jombang</h3>
          <p className="text-sm text-[#64748B] mt-2"><b>Apakah bisa antar ke Jombang?</b> Bisa, gratis 5km, di atas itu tambah 10k.</p>
          ...
          <a href="https://wa.me/6281289538855?text=Halo%20kak%20mau%20rental%20PS%20Jombang%20-%20utm_source=rental-ps-jombang&utm_medium=wa" target="_blank" className="mt-4 inline-block bg-[#25D366] text-white px-6 py-3 rounded-[12px] font-semibold cursor-pointer">Chat WA 0812-8953-8855</a>
        </div>
      </section>
    </main>
  )
