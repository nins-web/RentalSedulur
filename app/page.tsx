      ...
      <div className="mt-6 space-y-3">
        {(bookings||[]).map((b:any)=>(
          <div key={b.id} className="bg-zinc-900 p-4 rounded-xl flex justify-between">
            ...
            <a href={https://wa.me/${b.wa.replace(/^0/,'62')}?text=${encodeURIComponent(Halo ${b.nama}, booking ${b.unit_id} ${b.paket} dikonfirmasi)}} target="_blank" className="bg-green-600 px-4 py-2 rounded-lg h-fit">Chat</a>
          </div>
        ))}
