...
export const metadata = {
  title: 'Rental PS Sidoarjo — PS4 75k/malam, 8 Unit Siap Antar | Rental Sedulur',
  description: 'Rental PS Sidoarjo termurah — 5 PS4 130k/hari 75k/malam 500k/minggu, 3 PS3 100k/50k/350k. Paket malam hemat 40%, antar gratis kota, booking anti bentrok. WA 081289538855',
}
export default async function RentalSidoarjo(){
  let units:any[]=[]
    ...
    <main className="bg-[#F8FAFC] min-h-screen">
      <section className="bg-[#0F0F23] text-[#E2E8F0] py-12">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="mt-3 text-[#94A3B8]">Wilayah: Sidoarjo Kota, Sooko, Puri, Jetis, Gedeg — antar 1 jam, gratis 5km. Paket malam 19:00-07:00 cuma 75k (PS4).</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8">
        <h2 className="font-heading font-bold text-xl">Daftar Harga Sidoarjo</h2>
        ...
        <div className="mt-8 bg-white border border-[#E2E8F0] rounded-[12px] p-6">
          <h3 className="font-bold">FAQ Rental PS Sidoarjo</h3>
          ...
          <a href="https://wa.me/6281289538855?text=Halo%20kak%20mau%20rental%20PS%20Sidoarjo" target="_blank" className="mt-4 inline-block bg-[#25D366] text-white px-6 py-3 rounded-[12px] font-semibold cursor-pointer">Chat WA 0812-8953-8855</a>
        </div>
      </section>
    </main>
  )
